...
`;
    ...
    const { Component: Component$d, useState: useState$d } = owl__namespace;
    const { xml: xml$f } = owl__namespace.tags;
...
`;
  ...
  `;
    ...
    const { Component: Component$b, useState: useState$c, hooks: hooks$2 } = owl__namespace;
...
`;
    ...
    const { Component: Component$a, useState: useState$b, hooks: hooks$1 } = owl__namespace;
...
`;
    ...
    const { Component: Component$9, useState: useState$a } = owl__namespace;
...
`;
  ...
  `;
    ...
    const { Component: Component$6, useState: useState$7 } = owl__namespace;
...
`;
    ...
    exports.__info__.date = '2022-11-17T11:29:54.003Z';
    exports.__info__.hash = '0f0e2c5';
